...
if (!$codigo) {
    die("Error: No se ha especificado el código del paciente.");
}


$stmt = $pdo->prepare("SELECT COUNT(*) FROM Tratamiento WHERE id_paciente = ?");
$stmt->execute([$codigo]);
$linea_actual = $stmt->fetchColumn() + 1;
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    try {
        ...
        header("Location: ver_paciente.php?codigo=" . urlencode($codigo));
        exit;
...
<body class="bg-light">
    <div class="container py-5" style="max-width: 900px;">
        <div class="d-flex justify-content-between mb-4">
            <h4 class="text-primary fw-bold">Nuevo Tratamiento (Paciente: <?= htmlspecialchars($codigo) ?>)</h4>
            <a href="ver_paciente.php?codigo=<?= urlencode($codigo) ?>" class="btn btn-outline-secondary">Cancelar</a>
        </div>
        ...
        <form method="POST" action="nuevo_tratamiento.php?codigo=<?= urlencode($codigo) ?>">
                    ...
                    <div class="row g-3 align-items-end">
                        <div class="col-md-4">
                            ...
                            <div class="input-group">
                                <input type="number" name="escala_cirs" class="form-control" placeholder="0-86">
                                <a href="https://www.mdcalc.com/calc/10088/cumulative-illness-rating-scale-geriatric-cirs-g" target="_blank" class="btn btn-outline-primary" title="Ir a Calculadora CIRS"><i class="bi bi-calculator"></i></a>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <label class="form-label">CLL-IPI (Valor)</label>
                            <div class="input-group">
                                <input type="number" name="escala_cll_ipi_valor" class="form-control" placeholder="Puntuación">
                                <a href="https://www.mdcalc.com/calc/4054/international-prognostic-index-chronic-lymphocytic-leukemia-cll-ipi" target="_blank" class="btn btn-outline-primary" title="Ir a Calculadora CLL-IPI"><i class="bi bi-calculator"></i></a>
                            </div>
                        </div>
                        <div class="col-md-4">
                            ...
                            <select name="escala_cll_ipi_riesgo" class="form-select">
                                ...
                                <option value="Bajo Riesgo(0-1)">Bajo Riesgo (0-1)</option>
                                <option value="Riesgo Intermedio (2-3)">Riesgo Intermedio (2-3)</option>
                                <option value="Alto Riesgo (<04)">Alto Riesgo (&lt;04)</option>
                            </select>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body">
                    <div class="row g-3">
                        ...
                        <div class="col-md-4" id="div_otro" style="display:none;">
                            ...
                            <input type="text" name="esquema_otro" id="input_otro" class="form-control">
                        </div>
                        <div class="col-md-4">
                                    ...
                                    <?php foreach ($mapa_indicaciones as $corto => $largo): ?>
                                        <div class="col-md-6 mb-2">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" name="indicacion[]" value="<?= $corto ?>" id="chk_<?= md5($corto) ?>">
            ...
            <div class="card shadow-sm mb-4">
                ...
                <div class="card-body">
                    <div class="row g-3">
                        <div class="col-md-2"><label class="small">Linfocitos</label><input type="number" step="0.01" name="linfocitos" class="form-control form-control-sm"></div>
                        <div class="col-md-2"><label class="small">Leucocitos</label><input type="number" step="0.01" name="leucocitos" class="form-control form-control-sm"></div>
                        <div class="col-md-2"><label class="small">Plaquetas</label><input type="number" step="0.01" name="plaquetas" class="form-control form-control-sm"></div>
                        <div class="col-md-2"><label class="small">Neutrófilos</label><input type="number" step="0.01" name="neutrofilos" class="form-control form-control-sm"></div>
                        <div class="col-md-2"><label class="small">Creatinina</label><input type="number" step="0.01" name="creatinina" class="form-control form-control-sm"></div>
                    </div>
                    
                    <div class="row g-3 mt-1">
                        <div class="col-md-12">
                            <label class="small">Otro</label>
                            <input type="text" name="otra_analitica" class="form-control form-control-sm" placeholder="Especificar...">
                        </div>
                    </div>
                    ...
                    <div class="row g-3 align-items-center">
                        <div class="col-md-3">
                            ...
                            <select name="igvh" class="form-select form-select-sm">
                                ...
                                <option value="No mutado">No mutado</option>
                            </select>
                        </div>
                        <div class="col-md-2">
                        ...
                        <div class="col-md-2">
                            <div class="form-check mt-4">
                                <input type="checkbox" name="cariotipo_complejo" value="1" class="form-check-input">
                        ...
                        <div class="col-md-5">
                            ...
                            <div class="d-flex gap-2 flex-wrap">
                                <div class="form-check"><input type="checkbox" name="fish_del17p" class="form-check-input"> 17p</div>
                                <div class="form-check"><input type="checkbox" name="fish_del11q" class="form-check-input"> 11q</div>
                                <div class="form-check"><input type="checkbox" name="fish_trisomia12" class="form-check-input"> +12</div>
                                <div class="form-check"><input type="checkbox" name="fish_del13q" class="form-check-input"> 13q</div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row g-3">
                        <div class="col-md-4">
                            ...
                            <select name="respuesta" class="form-select">
                                <option value="">Seleccione...</option>
                                <option value="RC (Respuesta completa)">RC (Respuesta completa)</option>
                                <option value="RCi (Respuesta completa incompleta)">RCi (Respuesta completa incompleta)</option>
                                <option value="RP (Respuesta parcial)">RP (Respuesta parcial)</option>
                                <option value="RP-linfocitosis">RP-linfocitosis</option>
                                <option value="EE (Enfermedad estable)">EE (Enfermedad estable)</option>
                                <option value="E.Progresiva">E.Progresiva</option>
                            </select>
                        </div>
                        <div class="col-md-4">
            ...
            <button type="submit" class="btn btn-primary w-100 fw-bold">GUARDAR TRATAMIENTO</button>
        </form>
    </div>
</body>
</html>